...
const AstrologyBlog = ({ dispatch, myblogdata }) => {
    ...
    // };
    // const DATA = [
    //     { id: '1', image: images.samagri, title: 'Decoding Astrobook’s fortune: How the astrology startup hit success by blending ancient', Date: '1-nov-24', Viewers: "1923",description:"Acharya Anuj, Founder and CEO of astrobook, launched the app with a mission to bring authentic astrology services to everyone. His journey began with a life changing prediction during a challenging phase int his career, An astrologers insight gave Puneet the confidence and guidance he needed, helping him make pivotal decision that eventually led to hsi success."},
    //     { id: '2', image: images.flowers, title: 'Decoding Astrobook’s fortune: How the astrology startup hit success by blending ancient', Date: '1-nov-24', Viewers: "2344" ,description:"shiva, Founder and CEO of astrobook, launched the app with a mission to bring authentic astrology services to everyone. His journey began with a life changing prediction during a challenging phase int his career, An astrologers insight gave Puneet the confidence and guidance he needed, helping him make pivotal decision that eventually led to hsi success."},
    //     { id: '3', image: images.heart, title: 'Decoding Astrobook’s fortune: How the astrology startup hit success by blending ancient', Date: '1-nov-24', Viewers: "6923" ,description:"shiva, Founder and CEO of astrobook, launched the app with a mission to bring authentic astrology services to everyone. His journey began with a life changing prediction during a challenging phase int his career, An astrologers insight gave Puneet the confidence and guidance he needed, helping him make pivotal decision that eventually led to hsi success."},
    //     { id: '4', image: images.heart2, title: 'Decoding Astrobook’s fortune: How the astrology startup hit success by blending ancient', Date: '1-nov-24', Viewers: "1003",description:"shiva, Founder and CEO of astrobook, launched the app with a mission to bring authentic astrology services to everyone. His journey began with a life changing prediction during a challenging phase int his career, An astrologers insight gave Puneet the confidence and guidance he needed, helping him make pivotal decision that eventually led to hsi success." },

    // ];
    const renderItem = ({ item }) => {
        console.log('CheckData:::KKK',item)
        return (


            <TouchableOpacity
                onPress={() => navigation.navigate('BlogDescription', { blogData: item })}
                style={{ borderWidth: 1, height: SCREEN_HEIGHT * 0.3, width: SCREEN_WIDTH * 0.95, borderRadius: 10, alignItems: "center", borderColor: "#A9A9A9", elevation1: 10, marginVertical: SCREEN_HEIGHT * 0.01, overflow: "hidden" }}>
                ...
                <View style={{ flexDirection: "row", width: SCREEN_WIDTH * 0.95, justifyContent: "space-between", alignItems: "center", paddingHorizontal: SCREEN_WIDTH * 0.02, paddingTop: SCREEN_HEIGHT * 0.005 }}>
                    ...
                    <Text style={{ ...Fonts.primaryHelvetica, fontSize: 12, color: colors.black_color6 }}>{item?.createdAt}</Text>
                </View>
