...
import { responsiveScreenHeight, responsiveScreenWidth, useResponsiveScreenWidth } from 'react-native-responsive-dimensions';
  ...
  function MyBlogs() {
    ...
    const renderItem = ({ item }) => {
      return (
        ...
        <View style={{ borderWidth: 1, height: SCREEN_HEIGHT * 0.23, width: SCREEN_WIDTH * 0.6, borderRadius: 10, alignItems: "center", borderColor: "#A9A9A9", elevation1: 2, marginHorizontal: SCREEN_WIDTH * 0.01 }}>

          <View style={{ width: SCREEN_WIDTH * 0.6, height: SCREEN_HEIGHT * 0.15, alignItems: "center", justifyContent: "center" }}>
            <Image
              style={{ width: SCREEN_WIDTH * 0.6, height: SCREEN_HEIGHT * 0.15, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}
              source={{uri:img_url + item?.image}} />
          </View>
          ...
          <View style={{ flexDirection: "row", width: SCREEN_WIDTH * 0.6, justifyContent: "space-between", alignItems: "center", paddingHorizontal: SCREEN_WIDTH * 0.015 }}>
            ...
            <Text style={{ ...Fonts.primaryHelvetica, fontSize: 10, color: colors.black_color6 }}>{item?.createdAt}</Text>
          </View>
