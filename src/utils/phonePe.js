    ...
    console.log('order',orderId, amount,customerId,phone)
        ...
        if(result) {
         const data =  {
            ...
            amount: amount * 100,
            callbackUrl: "https://astrobookbackend.ksdelhi.net/customers/callbackPhonepe",
            mobileNumber: phone,
            paymentInstrument: {
              type: "PAY_PAGE"
            }
  ...
  console.log('order',orderId, amount,customerId,phone)
      ...
      if(result) {
       const data =  {
          ...
          merchantUserId: customerId,
          amount: amount * 100,
          callbackUrl: "https://astrobookbackend.ksdelhi.net/ecommerce/order_product_callback",
          mobileNumber: phone,
          paymentInstrument: {
            type: "PAY_PAGE"
          }
